                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="active">
                                <option value="1" @if ($config->active == 1) selected @endif>Aktif</option>
                                <option value="0" @if ($config->active == 0) selected @endif>Pasif</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <img src="{{asset($config->logo)}}" width="100" class="img-thumbnail rounded">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <img src="{{asset($config->favicon)}}" width="100" class="img-thumbnail rounded">
